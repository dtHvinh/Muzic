...
export default function AddArtistButton() {
  ...
  return (
    <>
      <button
        className="rounded-full! bg-primary! h-9 flex items-center justify-between"
          ...
          <div className="relative w-full max-w-lg rounded-2xl bg-background p-6 px-8 shadow-2xl border-2 border-gray-500">
            ...
            <div className="mt-8 flex justify-end gap-3">
              ...
              <button
                ...
                className="rounded-lg border border-input px-5 py-2.5 font-medium hover:bg-secondary bg-primary!"
              >
                Add Artist
              </button>
            </div>
