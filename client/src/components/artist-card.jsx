...
export default function ArtistCard({
    ...
    return (
        <div className="group relative cursor-pointer text-center">
            ...
            <div className={`relative mx-auto mb-3 h-${cardProps.size} w-${cardProps.size} overflow-hidden rounded-full ring-4 ring-transparent transition-all group-hover:ring-primary/20`}>
                <img
