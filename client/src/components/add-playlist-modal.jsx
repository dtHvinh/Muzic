...
export default function AddPlaylistModal({ open, onClose }) {
    ...
    const { fireOnSuccess } = useAddPlaylistModal();
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-10">
            ...
            <div
                className="relative w-full max-w-xl overflow-hidden rounded-3xl border border-white/10 bg-linear-to-br from-[#111016] via-[#151622] to-[#10121a] shadow-[0_30px_80px_-40px_rgba(139,92,246,0.45)] transition-all duration-200"
                role="dialog"
                aria-modal="true"
            >
                    ...
                    <header className="flex items-start justify-between gap-6">
                        <div>
                            ...
                            <p className="mt-2 max-w-xl text-sm text-muted-foreground">
                                Give your playlist a name and optional description to help users
                                understand its vibe.
                            </p>
                        </div>
                        <button
                    ...
                    <form className="grid gap-6" onSubmit={handleSubmit}>
                        <label className="group flex flex-col gap-2">
                            ...
                            <input
                                ...
                                placeholder="eg. Late Night Coding"
                                required
                            />
                        </label>
                        ...
                        <label className="group flex flex-col gap-2">
                            ...
                            <textarea
                                ...
                                placeholder="Optional short description of the playlist."
                            />
                        </label>
                        ...
                        <div className="flex flex-col-reverse gap-3 md:flex-row md:items-center md:justify-between">
                            ...
                            <button
                                type="submit"
                                className="w-full rounded-2xl bg-primary! px-6 py-3 text-sm font-semibold shadow-[0_15px_40px_-15px_rgba(139,92,246,0.55)] transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-[0_20px_45px_-20px_rgba(139,92,246,0.7)] disabled:translate-y-0 disabled:opacity-60 disabled:shadow-none md:w-auto"
                                disabled={isLoading}
                            >
