...
export default function ArtistEdit() {
    ...
    const handleSave = async () => {
        ...
        try {
            const payload = {
                name: form.name.trim() || randomName(),
                bio: form.bio.trim() || randomBio(),
                profileImage: form.profileImage.trim() || randomImage(),
                spotifyId: form.spotifyId.trim() || randomSpotifyId(),
            };
        ...
        <div className="min-h-screen bg-background py-12 px-4">
            <div className="mx-auto max-w-4xl">
                ...
                <div className="space-y-8 rounded-3xl bg-card p-10 shadow-xl">
                    ...
                    <div>
                        <label className="mb-3 block text-lg font-semibold">Profile Image URL</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="mb-3 block text-lg font-semibold">Spotify ID</label>
                        <input
                            type="text"
